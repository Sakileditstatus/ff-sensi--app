      ...
      <div className="space-y-6">
        <div className="glass p-6 border-l-4 border-l-[#007AFF]">
          ...
          <p className="text-[var(--muted-text)] text-sm font-semibold">
            SENCI is a utility application designed to provide insights into
            your device's status and performance metrics. It acts as an
            easy-to-use dashboard to keep you informed about your phone's active
            state and background resource consumption.
          </p>
        </div>
        <div className="glass p-6 border-l-4 border-l-purple-500">
          ...
          <p className="text-[var(--muted-text)] text-sm font-semibold">
            By implementing a streamlined interface, SENCI allows you to view
            system information easily. It uses standard APIs to report device
            statistics without modifying system settings or requiring special
            permissions, giving you a clear view of your device's operational
            status.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="relative z-10 max-w-7xl mx-auto px-6 pt-8 pb-0 md:pt-16 md:pb-0">
        ...
        <div className="grid lg:grid-cols-2 gap-2 lg:gap-20 items-center">
          <div className="text-left">
            ...
            <p
              ...
              data-aos-delay="300"
            >
              Keep track of your device with clarity. Senci is an advanced
              utility for viewing system metrics and resource usage.
            </p>
            <div
      ...
      <section className="mb-20">
        <SectionHeader title="App Features" subtitle="Utility Tools" centered />
